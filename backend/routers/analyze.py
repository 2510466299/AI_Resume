...
def analyze_stream_endpoint(payload: AnalyzeRequest) -> StreamingResponse:
    ...
    def event_iterator():
        ...
        try:
            resume_profile, job_profile, raw_parse = parse_resume_and_job(
                payload.resume_text,
                payload.jd_text,
            ...
            gap_analysis, jd_mapping, raw_gap = analyze_gaps_and_mapping(
                resume_profile,
                job_profile,
                llm_config=llm_config,
                return_raw=True,
            ...
            learning_plan, raw_plan = generate_learning_plan(
                gap_analysis,
                llm_config=llm_config,
                return_raw=True,
            )
            ...
            custom_resume_markdown, raw_resume = generate_custom_resume(
                payload.resume_text,
                payload.jd_text,
                llm_config=llm_config,
                return_raw=True,
